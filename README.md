...
*This work was done as part of my Coursera programming assignment for "R Programming". Here we use the airpolution dataset to play around with the data and draw inferences based on the function outputs.
...
The zip file containing the data can is attached here: specdata.zip
